...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template name="Middle">
    <p> New Program has been registered, Please find the details below.</p>
  </xsl:template>

  <xsl:template name="Description">
    <p> For any queries contact 972.633.1388</p>
  </xsl:template>
                                ...
                                <tbody>
                                  <tr>
                                    <td valign="top" class="mcnTextContent" style="padding-top:9px; padding-right: 18px; padding-bottom: 9px; padding-left: 18px;">
                                      <em>Copyright � 2015 Surscan, All rights reserved.</em><br />
                                      <br />
                                                  ...
                                                  <tbody>
                                                    <tr>
                                                      <td valign="top" class="mcnTextContent" style="padding-top:9px; padding-right: 18px; padding-bottom: 9px; padding-left: 18px;">
                                                        ...
                                                        <p>
                                                          Donor Name :
                                                             <xsl:value-of select="Root/DonorName" />
                                                        </p>
                                                        <p>
                                                          Donor Email :
                                                           <xsl:value-of select="Root/DonorEmail" />
                                                        </p>
                                                        <p>
                                                          Donor SSN :
                                                           <xsl:value-of select="Root/DonorSSN" />
                                                        </p>
                                                        <p>
                                                          Donor DOB :
                                                           <xsl:value-of select="Root/DonorDOB" />
                                                        </p>
                                                        <p>
                                                          Donor City :
                                                           <xsl:value-of select="Root/DonorCity" />
                                                          </p>
                                                        <p>
                                                          Donor State :
                                                             <xsl:value-of select="Root/DonorState" />
                                                          </p>
                                                        <p>
                                                          Donor Zip Code :
                                                           <xsl:value-of select="Root/DonorZipCode" />
                                                        </p>
                                                        <p>
                                                          Client Name : <span style="color:#A20200">
                                                             <xsl:value-of select="Root/ClientName" />
                                                          </span>
                                                        </p>
                                                        <p>
                                                          Program Name : <span style="color:#A20200">
                                                             <xsl:value-of select="Root/ClientDepartmentName" />
                                                          </span>
                                                        </p>
                                                        <p>
                                                          Amount : <span style="color:#A20200">
                                                            $ <xsl:value-of select="Root/PaymentAmount" />
                                                          </span>
                                                        </p>
                                                        <p>
