...
CREATE TABLE `backend_notifications` (
  ...
  `update_hold` tinyint(4) NOT NULL DEFAULT '0',
...
) ENGINE=InnoDB AUTO_INCREMENT=137394 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `donor_test_info` (
  ...
  `mro_type_id` int(11) NOT NULL,
  `payment_type_id` int(11) NOT NULL,
  `test_requested_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
) ENGINE=InnoDB AUTO_INCREMENT=107876 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=114665 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=89745 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=89043 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=3054926 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=5747448 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=36746343 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=4064756 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--   select @zip, @dlat, @dlong, @dist;
  ...
  left outer join vendors on vendor_addresses.vendor_id = vendors.vendor_id
	...
	where vendor_addresses.address_type_id = @locType and vendors.vendor_status = 1
  order by dt.d2c;
...
-- Dump completed on 2020-04-09 21:12:50
