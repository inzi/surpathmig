...
namespace SurPathWeb.Controllers
{
    public class CourtController : Controller
    {
        ...
        public ActionResult TestResult()
        {
            ...
            searchParam.Add("CourtId", Session["CourtId"].ToString());
            ...
            DataTable dtDonors = donorBL.GetDonorsByCourt(Convert.ToInt32(Session["CourtId"]));
        ...
        public ActionResult UserProfile()
        {
            try
            {
                ...
                var Courtinfo = userbl.Get(userid);

                if (Courtinfo != null)
                {
                    DonorProfileDataModel model = new DonorProfileDataModel();

                    model.Username = Courtinfo.Username;
                    model.EmailID = Courtinfo.UserEmail;
                    model.FirstName = Courtinfo.UserFirstName;
                    model.LastName = Courtinfo.UserLastName;
                    model.Phone1 = Courtinfo.UserPhoneNumber;
                    model.Fax = Courtinfo.UserFax;
        ...
        public ActionResult UserProfile(DonorProfileDataModel model)
        {
            ...
            if (user == null || user.UserId == userid)
            {
                ...
                if (Courtinfo != null)
                {
                    //Courtinfo.Username = model.CourtUsername;
                    Courtinfo.UserEmail = model.EmailID;
                    Courtinfo.UserFirstName = model.FirstName;
                    Courtinfo.UserLastName = model.LastName;
                    Courtinfo.UserPhoneNumber = model.Phone1;
                    Courtinfo.UserFax = model.Fax;

                    int status = userbl.Save(Courtinfo);

                    if (status == 1)
                    {
                        Session["UserName"] = Courtinfo.UserFirstName + " " + Courtinfo.UserLastName;
