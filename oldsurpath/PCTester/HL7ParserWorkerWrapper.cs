...
namespace HL7ParserService
{
    ...
    internal class HL7ParserWorkerWrapper
    {
        private BackendData backendData;
        private BackendLogic backendLogic;
        private HL7ParserWorker worker;
        ...
        public HL7ParserWorkerWrapper(ILogger logger, IConfigurationRoot configuration)
        {
            ConfigurationRoot = configuration;
            _logger = logger;
            //backendData = new BackendData(null, null, _logger);
            backendLogic = new BackendLogic("SERVICE", _logger, false);
        ...
        public bool Work()
        {
            worker = new HL7ParserWorker(_logger);
