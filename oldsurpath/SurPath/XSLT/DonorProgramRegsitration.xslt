...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    <td class="mcnImageContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; text-align:center;">
                                      ...
                                      <img align="center" alt="" src="@Model.HeaderLogoBC" width="193" style="max-width:193px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage" />
                                    </td>
                                  </tr>
                                </tbody>
                              </table>
  ...
  <xsl:template name="Middle">
    <p> Thanks for registering your program. Please find the confirmation details below.</p>
  </xsl:template>

  <xsl:template name="Description">
    <p> For any questions please contact Surscan at 972.633.1388</p>
  </xsl:template>
                                                  ...
                                                  <tbody>
                                                    <tr>
                                                      <td valign="top" class="mcnTextContent" style="padding-top:9px; padding-right: 18px; padding-bottom: 9px; padding-left: 18px;">
                                                        ...
                                                        <p>
                                                          Program Name : <span style="color:#A20200"> <xsl:value-of select="Root/ClientDepartmentName" />
                                                          </span>
                                                        </p>
