...
namespace SurPath.Controls.TextBoxes
{
    public class SurTextBox : TextBox
    {
        #region Fields

        #region Protected Fields

        protected string _waterMarkText = "Text"; //The watermark text
        ...
        /// <summary>
        /// Initializes watermark properties and adds SurTextBox events
        /// </summary>
