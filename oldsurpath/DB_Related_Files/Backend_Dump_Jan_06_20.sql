...
) ENGINE=InnoDB AUTO_INCREMENT=116472 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=94002 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=98179 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=77967 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=25359 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `backend_only_digits`(as_val VARCHAR(2048)) RETURNS varchar(2048) CHARSET latin1
    DETERMINISTIC
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `GetSendInDate`( client_id int, client_department_id int, max_sendins int, utstart INT, utend INT, sunday INT, monday INT, tuesday INT, wednesday INT, thursday INT, friday INT, saturday INT ) RETURNS int(11)
    DETERMINISTIC
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `backend_get_deadline_donors_dataview`(
)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `backend_get_exception_count`()
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `backend_get_Send_in_Schedule_Exceptions_dataview`(
)
BEGIN
...
BEGIN
  ...
  select 
    ...
    if (bn.notified_by_email>0,bn.notified_by_email_timestamp,"No Notified") as DateDonorNotified,
        d.donor_id AS DonorId,
    if (ba.auto_reply_text is null, "",ba.auto_reply_text)  as auto_reply_text,
    ba.donor_test_info_id  as donor_test_info_id ,
    ba.backend_sms_activity_id as backend_sms_activity_id 
--     ,ba.*
--     ,bn.*
  from backend_sms_activity ba
    inner join donor_test_info dti on dti.donor_test_info_id = ba.donor_test_info_id
...
BEGIN
 ...
 declare test_id int(11) DEFAULT 0;
 declare sweep datetime;
 declare start datetime;
 declare datestart datetime;
 declare stop datetime;
 declare SendInDate int(11);
...
--   if exists (select * from backend_notifications where donor_test_info_id =100815) then
--   
--     select "nope";
--   
--   end if;
  
  if exists(select b.backend_notifications_id from backend_notifications as b 
  where b.donor_test_info_id =donor_test_info_id ) then
...
--   select "here3";
  ...
  IF not exists (select b.backend_notifications_id from backend_notifications as b 
  where b.donor_test_info_id =donor_test_info_id)
  THEN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `scratch`( client_id int, client_department_id int, max_sendins int, utstart INT, utend INT, sunday INT, monday INT, tuesday INT, wednesday INT, thursday INT, friday INT, saturday INT )
BEGIN
...
-- Dump completed on 2020-01-06 23:45:02
