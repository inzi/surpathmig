...
) ENGINE=InnoDB AUTO_INCREMENT=138649 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=108404 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=115264 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Temporary view structure for view `donordocumenttotals`
--
...
CREATE TABLE `donors` (
  ...
  `donor_pid` varchar(255) DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=90211 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=3099438 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=5831458 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=37263316 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `report_info` (
  ...
  KEY `idx_report_info_data_checksum` (`data_checksum`)
) ENGINE=InnoDB AUTO_INCREMENT=4118804 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `report_info_max` (
  ...
  `donor_gender` varchar(2) DEFAULT NULL,
  `final_report_id` int(11) DEFAULT NULL,
  KEY `Speedup1max` (`report_info_id`,`specimen_id`,`lab_sample_id`),
  KEY `Speedup2max` (`report_info_id`,`specimen_id`,`final_report_id`),
  KEY `searchtabmax` (`report_info_id`,`specimen_id`,`donor_last_name`),
  KEY `SSN_IDmax` (`ssn_id`),
  KEY `DONOR_DOBmax` (`donor_dob`),
  KEY `RI_SpecimenIDmax` (`specimen_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `report_info_repair1` (
  ...
  `created_on` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `last_modified_on` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  KEY `idx_report_info_repair1_id` (`report_info_id`,`created_on`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=28667 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=43374 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`surpath`@`%` PROCEDURE `backend_get_user_activity`(
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`surpath`@`%` PROCEDURE `backend_set_user_activity`(
in activity_user_id int, 
in activity_user_category_id int, 
in is_activity_visible int, 
in activity_note varchar(6000), 
...
-- Dump completed on 2020-03-14 18:40:41
