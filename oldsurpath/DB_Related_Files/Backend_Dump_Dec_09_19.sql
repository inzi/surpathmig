...
BEGIN
  ...
  where a.clinic_exception > 0 or a.notification_email_exception > 0 or a.notification_sms_exception >0 limit 100;
...
--   set backend_notifications_id := test_id;
  ...
  ELSE
    ...
    set 
      ...
      notify_now= if (notify_now>0,1,0),
      notify_next_window= if (notify_next_window>0,1,0),
...
-- Dump completed on 2019-12-09 22:51:38
