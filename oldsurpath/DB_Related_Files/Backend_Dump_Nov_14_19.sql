...
CREATE TABLE `backend_notifications` (
  ...
  `notification_exception` int(11) NOT NULL DEFAULT '0',
  ...
  `notify_exception_timestamp` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
...
CREATE TABLE `backend_sms_replies` (
  ...
  `backend_sms_queue_id` int(11) NOT NULL,
  `reply` varchar(150) DEFAULT NULL,
  `dt_reply_recieved` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `created_on` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `created_by` varchar(200) NOT NULL,
  `last_modified_on` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `last_modified_by` varchar(200) NOT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=116332 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--   *,
  ...
  and bn.notification_exception =0
  order by dti.created_on desc
  limit 5;
...
BEGIN
 ...
 declare test_id int(11) DEFAULT 0;
  ...
  THEN
    ...
    notification_exception, 
    if (notification_exception>0,CURRENT_TIMESTAMP, '0000-00-00 00:00:00'),
    clinic_exception, 
  ...
  ELSE
    ...
    set 
      ...
      notification_exception = notification_exception, 
      notify_exception_timestamp = if (notification_exception>0,CURRENT_TIMESTAMP, '0000-00-00 00:00:00'),
...
BEGIN
  ...
  ELSE
    ...
    (client_id,client_department_id, client_sms_apikey, client_sms_from_id, client_sms_token, created_by, last_modified_by) 
    VALUES (client_id,client_department_id, client_sms_apikey, client_sms_from_id, client_sms_token, created_by, last_modified_by);
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `backend_set_sms_reply` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = latin1 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `backend_set_sms_reply`(
  in backend_sms_queue_id int,
...
BEGIN
  ...
  (backend_sms_queue_id, reply, created_by, last_modified_by) 
  VALUES (backend_sms_queue_id, reply, created_by, last_modified_by);
...
-- Dump completed on 2019-11-14 20:59:17
