...
) ENGINE=InnoDB AUTO_INCREMENT=116343 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
BEGIN
  select * 
  ,backend_in_notification_window(a.client_id, a.client_department_id,0 ) as in_window
  from backend_notification_window_data a where (a.client_id = client_id and a.client_department_id= client_department_id);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
  ...
  order by backend_sms_activity_id desc;
...
-- Dump completed on 2019-12-19  1:38:42
