...
using inzibackend.Web.UiCustomization.Metronic;

namespace inzibackend.Web.UiCustomization
{
    public class UiThemeCustomizerFactory : IUiThemeCustomizerFactory
    {
        ...
        private IUiCustomizer GetUiCustomizerInternal(string theme)
        {
            ...
            if (theme.Equals(AppConsts.Theme0, StringComparison.InvariantCultureIgnoreCase))
            {
                return _serviceProvider.GetService<Theme0UiCustomizer>();
            }
