...
using inzibackend.UiCustomization.Dto;

namespace inzibackend.Web.UiCustomization.Metronic
{
    public class Theme0UiCustomizer : UiThemeCustomizerBase, IUiCustomizer
    {
        public Theme0UiCustomizer(ISettingManager settingManager)
            : base(settingManager, AppConsts.Theme0)
        {
        }
