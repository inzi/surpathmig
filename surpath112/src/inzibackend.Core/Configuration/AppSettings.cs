namespace inzibackend.Configuration
{
    ...
    public static class AppSettings
    {
        ...
        {
            public const string EnableGlobalPaymentPopup = "App.PaymentPopup.EnableGlobal";
            public const string EnablePaymentPopupForCohort = "App.PaymentPopup.EnableForCohort";
            public const string EnablePaymentPopupForDepartment = "App.PaymentPopup.EnableForDepartment";
        }
