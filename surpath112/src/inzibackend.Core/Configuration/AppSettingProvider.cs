...
using inzibackend.Authentication;
...
namespace inzibackend.Configuration
{
    ...
    public class AppSettingProvider : SettingProvider
    {
        ...
        {
            if (!inzibackendConsts.AllowTenantsToChangeEmailSettings)
            {
        ...
        private IEnumerable<SettingDefinition> GetHostSettings()
        {
            return new[]
            {
                ...
                new SettingDefinition(AppSettings.PaymentPopup.EnableGlobalPaymentPopup,
                    GetFromAppSettings(AppSettings.PaymentPopup.EnableGlobalPaymentPopup, "true"),
        ...
        private IEnumerable<SettingDefinition> GetTenantSettings()
        {
            return new[]
            {
                ...
                new SettingDefinition(AppSettings.PaymentPopup.EnablePaymentPopupForCohort,
                    GetFromAppSettings(AppSettings.PaymentPopup.EnablePaymentPopupForCohort, ""),
                    scopes: SettingScopes.Tenant),
                new SettingDefinition(AppSettings.PaymentPopup.EnablePaymentPopupForDepartment,
                    GetFromAppSettings(AppSettings.PaymentPopup.EnablePaymentPopupForDepartment, ""),
                    scopes: SettingScopes.Tenant),
                new SettingDefinition(AppSettings.Email.UseHostDefaultEmailSettings,
                    GetFromAppSettings(AppSettings.Email.UseHostDefaultEmailSettings,
                        inzibackendConsts.MultiTenancyEnabled ? "true" : "false"), scopes: SettingScopes.Tenant)
            };
        }
        ...
        private IEnumerable<SettingDefinition> GetTheme0Settings()
        {
            var themeName = "theme0";
        ...
        private IEnumerable<SettingDefinition> GetDashboardSettings()
        {
            ...
            return new[]
            {
                new SettingDefinition(
                    GetSettingName(
                        inzibackendDashboardCustomizationConsts.Applications.Mvc,
                ...
                new SettingDefinition(
                    GetSettingName(
                        inzibackendDashboardCustomizationConsts.Applications.Angular,
        ...
        public Dashboard GetDefaultMvcHostDashboardView()
        {
            ...
            {
                DashboardName = inzibackendDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard,
                Pages = new List<Page>
                {
                    new Page
                    {
                        Name = inzibackendDashboardCustomizationConsts.DefaultPageName,
                        Widgets = new List<Widget>
                        {
                            new Widget
                            {
                                WidgetId = inzibackendDashboardCustomizationConsts.Widgets.Host
                                    .TopStats, // Top Stats
                                Height = 6,
                                Width = 12,
                                PositionX = 0,
                            ...
                            {
                                WidgetId =
                                    inzibackendDashboardCustomizationConsts.Widgets.Host
        ...
        public Dashboard GetDefaultMvcTenantDashboardView()
        {
            ...
            return new Dashboard
            {
                DashboardName = inzibackendDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard,
                Pages = new List<Page>
                {
                    new Page
                    {
                        ...
                        Widgets = new List<Widget>
                        {
                            new Widget
                            {
                                WidgetId = inzibackendDashboardCustomizationConsts.Widgets.Tenant
                            ...
                            {
                                WidgetId =
                                    inzibackendDashboardCustomizationConsts.Widgets.Tenant
