...
namespace inzibackend.Notifications
{
    public interface IAppNotifier
    {
        ...
        Task RecordStateChanged(UserIdentifier user, LocalizableString localizableMessage, IDictionary<string, object> localizableMessageData = null, NotificationSeverity severity = NotificationSeverity.Info);
        Task RecordStateExpirationWarning(UserIdentifier user, LocalizableString localizableMessage, IDictionary<string, object> localizableMessageData = null, NotificationSeverity severity = NotificationSeverity.Info);

        //Task YouHaveUnreadNotifications(UserIdentifier user);
