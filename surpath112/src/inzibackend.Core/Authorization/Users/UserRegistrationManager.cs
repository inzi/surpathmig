...
{
    public class UserRegistrationManager : inzibackendDomainServiceBase
    {
            ...
            string phonenumber)
        {
            ...
            Logger.Debug($"UserRegistrationManager RegisterAsync");
            ...
            Logger.Debug($"UserRegistrationManager Initializing options in user manager");
            ...
            {
                Logger.Debug($"UserRegistrationManager Email not confirmed");
                user.SetNewEmailConfirmationCode();
                Logger.Debug($"UserRegistrationManager Sending activation link {emailActivationLink}");

                await _userEmailer.SendEmailActivationLinkAsync(user, emailActivationLink);
            }

            Logger.Debug($"UserRegistrationManager Sending notifications");
