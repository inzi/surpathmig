...
namespace inzibackend.Features
{
    public class AppFeatureProvider : FeatureProvider
    {
        public override void SetFeatures(IFeatureDefinitionContext context)
        {
            ...
            #endregion
            var SurPathFeature = context.Create(
                AppFeatures.SurpathFeature,
                defaultValue: "true",
                displayName: L("SurpathFeatures"),
                inputType: new CheckboxInputType()
                );
            SurPathFeature.CreateChildFeature(
                AppFeatures.SurpathFeatureDrugTest,
                defaultValue: "true",
                displayName: L("DrugTesting"),
                inputType: new CheckboxInputType()
            );
            SurPathFeature.CreateChildFeature(
                AppFeatures.SurpathFeatureBackgroundCheck,
                defaultValue: "true",
                displayName: L("BackgroundChecks"),
                inputType: new CheckboxInputType()
            );
            SurPathFeature.CreateChildFeature(
                AppFeatures.SurpathFeatureRecordCompliance,
                defaultValue: "true",
                displayName: L("ComplianceTracking"),
                inputType: new CheckboxInputType()
            );
            SurPathFeature.CreateChildFeature(
                AppFeatures.SurpathFeatureWGACADA,
                defaultValue: "false",
                displayName: L("WGADandADAaccessibe"),
                inputType: new CheckboxInputType()
            );
            ...
            chatFeature.CreateChildFeature(
                AppFeatures.TenantUserToTeantUserChatFeature,
                defaultValue: "false",
                displayName: L("TenantUserToTeantUserChatFeature"),
                inputType: new CheckboxInputType()
            );
            chatFeature.CreateChildFeature(
                AppFeatures.TenantUserToTenantAdminChatFeature,
                defaultValue: "false",
                displayName: L("TenantUserToTenantAdminChatFeature"),
                inputType: new CheckboxInputType()
            );
        }
