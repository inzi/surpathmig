...
namespace inzibackend.Migrator
{
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            using (var bootstrapper = AbpBootstrapper.Create<inzibackendMigratorModule>())
            {
                ...
                using (var migrateExecuter = bootstrapper.IocManager.ResolveAsDisposable<MultiTenantMigrateExecuter>())
                {
                    ...
                    using (var resolver = bootstrapper.IocManager.ResolveAsDisposable<IIocResolver>())
                    {
                        migrateExecuter.Object.SeedFromSPL(resolver.Object);
                    }
                }
