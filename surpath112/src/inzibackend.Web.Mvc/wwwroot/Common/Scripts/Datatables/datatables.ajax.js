...
(function ($) {
 ...
 // 
      ...
      if (settings.oInit.paging) {
          inputFilter = $.extend(inputFilter, {
              maxResultCount: inputFilter.hasOwnProperty('maxRecordCount') == true ? inputFilter.maxRecordCount : requestData.length,
              skipCount: inputFilter.hasOwnProperty('skipCount') == true ? inputFilter.skipCount : requestData.start,
          });
      }
