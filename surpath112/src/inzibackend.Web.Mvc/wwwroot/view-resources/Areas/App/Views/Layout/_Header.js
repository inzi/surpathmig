(function ($) {
    $(function () {
        // Back to my account
        console.log("_headers in Layout, binding to UserProfileBackToMyAccountButton");
        // Add logging for the actual element
        console.log("Button element:", $('#UserProfileBackToMyAccountButton')[0]);

        //// Add event capturing to see if the click event reaches the document
        //document.addEventListener('click', function(e) {
        //    debugger;
        //    if (e.target.id === 'UserProfileBackToMyAccountButton' ||
        //        e.target.closest('#UserProfileBackToMyAccountButton')) {
        //        console.log('Click captured at document level');
        //    }
        //}, true);

        //$('#UserProfileBackToMyAccountButton').click(function (e) {
        //    console.log("Click handler triggered"); // Add this line
        //    debugger;
        //    e.preventDefault();
        ...
        // Also try binding with on() method
        $(document).on('click', '#UserProfileBackToMyAccountButton', function (e) {
            //console.log("Click handler triggered via document delegation"); // Add this line
            e.preventDefault();
        ...
        console.log("UserProfileBackToMyAccountButton click now bound");
        console.log("_headers: ", $('#UserProfileBackToMyAccountButton').length, " UserProfileBackToMyAccountButton found");
        //My settings
