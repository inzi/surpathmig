(function ($) {
    app.modals.RecordCategoryLookupTableModal = function () {
        var _modalManager;
        console.log('RecordCategoryLookupTableModal compliance');

        var _complianceService = abp.services.app.surpathCompliance;

        var _$recordCategoryTable = $('#RecordCategoryTable');
        ...
        var dataTableCategory = _$recordCategoryTable.DataTable({
            paging: true,
        ...
        $('#RecordCategoryTable tbody').on('click', '[id*=selectbtn]', function () {
            var data = dataTableCategory.row($(this).parents('tr')).data();
