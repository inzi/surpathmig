(function () {
  $(function () {
    ...
    var _importUsersModal = new app.ModalManager({
      viewUrl: abp.appPath + 'App/Tenants/ImportUsersModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/App/Views/Tenants/_ImportUsersModal.js',
      modalClass: 'ImportTenantUsersModal',
    });
        ...
        },
        {
          ...
          rowAction: {
            ...
            items: [
              ...
              {
                text: app.localize('ImportUsers'),
                visible: function () {
                  return abp.auth.hasPermission('Pages.Tenants.ImportUsers');
                },
                action: function (data) {
                  _importUsersModal.open({ tenantId: data.record.id });
                },
              },
              {
