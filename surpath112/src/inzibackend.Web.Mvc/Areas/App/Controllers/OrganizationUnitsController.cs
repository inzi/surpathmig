...
using inzibackend.Web.Areas.App.Models.OrganizationUnits;
...
namespace inzibackend.Web.Areas.App.Controllers
{
    ...
    public class OrganizationUnitsController : inzibackendControllerBase
    {
        ...
        [AbpMvcAuthorize(AppPermissions.Pages_Administration_OrganizationUnits_ManageDepartments)]
        public PartialViewResult AddDepartmentModal(LookupModalViewModel model)
        {
