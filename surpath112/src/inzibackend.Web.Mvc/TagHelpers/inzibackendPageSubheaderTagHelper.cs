...
namespace inzibackend.Web.TagHelpers
{
    ...
    public class inzibackendPageSubheaderTagHelper : TagHelper
    {
        ...
        public inzibackendPageSubheaderTagHelper(IUiThemeCustomizerFactory uiThemeCustomizerFactory)
        {
