...
namespace inzibackend.Web.Public.Startup
{
    ...
    public class inzibackendWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public inzibackendWebFrontEndModule(IWebHostEnvironment env, inzibackendEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(inzibackendWebFrontEndModule).GetAssembly());
        }
    }
}
