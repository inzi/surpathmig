...
using inzibackend.Core.Base;
using inzibackend.Core.Extensions;
using inzibackend.Dto;
using inzibackend.Types;

namespace inzibackend.Queries
{
    public class OrganizationUnitQuery : inzibackendQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
