...
namespace inzibackend
{
    ...
    /// </summary>
    public abstract class inzibackendAppServiceBase : ApplicationService
    {
        public TenantManager TenantManager { get; set; }

        public UserManager UserManager { get; set; }

        public OUSecurityManager OUSecurityManager { get; set; }


        protected inzibackendAppServiceBase()
        {
