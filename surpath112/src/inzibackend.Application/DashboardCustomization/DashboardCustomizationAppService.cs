...
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : inzibackendAppServiceBase, IDashboardCustomizationAppService
    {
        ...
        private async Task SaveDashboardSettingForUser(string application, Dashboard dashboard)
        {
            ...
            //clean 'settings_' from widget settings stored in Json
