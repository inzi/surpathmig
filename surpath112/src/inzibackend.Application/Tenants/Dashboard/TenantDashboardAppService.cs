...
namespace inzibackend.Tenants.Dashboard
{
    ...
    public class TenantDashboardAppService : inzibackendAppServiceBase, ITenantDashboardAppService
    {
        ...
        //[AbpAuthorize(AppPermissions.Pages_Tenant_Dashboard)]//check permission
        public GetSurpathDeptOutput GetSurpathDeptData(GetSurpathDeptInput input)
        {
            return new GetSurpathDeptOutput()
            {
                OutPutName = "Hello " + input.Name
            };
        }
    }
}