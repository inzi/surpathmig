...
{
    public class inzibackendDashboardCustomizationConsts
    {
        /// <summary>
        ...
        public class Widgets
        {
            public class Tenant
            {
                ...
                public const string SurpathDept = "Widgets_Tenant_SurpathDept";// Surscan Working Filter
                public const string SurpathCohortCompliance = "Widgets_Tenant_CohortCompliance";
            }
        ...
        public class Filters
        {
            ...
            public const string SurpathDeptFilter = "Filters_SurpathDeptFilter";// Surscan Working Filter
        }
