...
{
    public class SubscriptionPaymentRepository : inzibackendRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<inzibackendDbContext> dbContextProvider)
