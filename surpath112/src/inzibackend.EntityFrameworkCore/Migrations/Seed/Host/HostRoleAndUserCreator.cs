...
namespace inzibackend.Migrations.Seed.Host
{
    public class HostRoleAndUserCreator
    {
        ...
        public HostRoleAndUserCreator(inzibackendDbContext context)
        {
            _context = context;
        }
        ...
        public void Create()
        {
            ...
            CreateHostRoleAndUsers("chris@surscan.com", "Chris", "Norman", "123qwe");
            CreateHostRoleAndUsers("david@surscan.com", "David", "Leonard", "surscan");
        }
        ...
        private void CreateHostRoleAndUsers()
        {
            ...
            if (adminUserForHost == null)
            {
                var user = new User
                {
                    ...
                    Name = "admin",
                    Surname = "admin",
                    EmailAddress = "chris@inzi.com", // "admin@aspnetzero.com",
        ...
        private void CreateHostRoleAndUsers(string email, string name, string surname, string password)
        {
            //Admin role for host
            ...
            var adminUserForHost = _context.Users.IgnoreQueryFilters().FirstOrDefault(u => u.TenantId == null && u.UserName ==email);
            if (adminUserForHost == null)
            {
                var user = new User
                {
