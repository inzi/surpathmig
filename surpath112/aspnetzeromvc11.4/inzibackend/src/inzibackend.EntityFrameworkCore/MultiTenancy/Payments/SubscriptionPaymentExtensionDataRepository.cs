...
using inzibackend.EntityFrameworkCore.Repositories;

namespace inzibackend.MultiTenancy.Payments
{
    public class SubscriptionPaymentExtensionDataRepository : inzibackendRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<inzibackendDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
