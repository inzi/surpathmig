...
{
    public class UserRepository : inzibackendRepositoryBase<User, long>, IUserRepository
    {
        public UserRepository(IDbContextProvider<inzibackendDbContext> dbContextProvider)
