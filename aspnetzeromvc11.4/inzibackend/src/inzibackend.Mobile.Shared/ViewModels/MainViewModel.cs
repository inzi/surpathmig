...
using inzibackend.Commands;
using inzibackend.Core.Threading;
using inzibackend.Models.NavigationMenu;
using inzibackend.Services.Navigation;
...
using inzibackend.Controls;
using inzibackend.Dto;
using inzibackend.Extensions;
using inzibackend.Localization;
using inzibackend.UI;
using inzibackend.UI.Assets;
using inzibackend.Views;
using DependencyResolver = inzibackend.Core.Dependency.DependencyResolver;
...
namespace inzibackend.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "inzibackend";
