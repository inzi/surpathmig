...
using inzibackend.Web.Public.Startup;
using inzibackend.Web.Session;

namespace inzibackend.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : inzibackendViewComponent
    {
