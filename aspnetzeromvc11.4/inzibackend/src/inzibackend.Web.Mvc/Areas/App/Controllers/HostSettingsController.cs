...
using inzibackend.Configuration.Host;
using inzibackend.Editions;
using inzibackend.Timing;
using inzibackend.Timing.Dto;
using inzibackend.Web.Areas.App.Models.HostSettings;
...
namespace inzibackend.Web.Areas.App.Controllers
{
    ...
    public class HostSettingsController : inzibackendControllerBase
    {
