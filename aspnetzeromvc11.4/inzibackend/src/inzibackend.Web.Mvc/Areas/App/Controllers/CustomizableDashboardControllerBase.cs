...
using inzibackend.DashboardCustomization.Dto;
using inzibackend.Web.Areas.App.Models.CustomizableDashboard;
...
{
    public abstract class CustomizableDashboardControllerBase : inzibackendControllerBase
    {
        ...
        public async Task<PartialViewResult> AddWidgetModal(string dashboardName, string pageId)
        {
            var availableWidgets = await DashboardCustomizationAppService.GetAllAvailableWidgetDefinitionsForPage(
                ...
                {
                    Application = inzibackendDashboardCustomizationConsts.Applications.Mvc,
                    PageId = pageId,
