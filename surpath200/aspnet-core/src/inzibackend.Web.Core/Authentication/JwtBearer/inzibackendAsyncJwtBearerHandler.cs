...
public class inzibackendAsyncJwtBearerHandler : AuthenticationHandler<AsyncJwtBearerOptions>
{
    ...
    /// </summary>
    /// <inheritdoc />
    public inzibackendAsyncJwtBearerHandler(IOptionsMonitor<AsyncJwtBearerOptions> options,
