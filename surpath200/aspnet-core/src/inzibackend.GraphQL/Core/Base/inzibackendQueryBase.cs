...
namespace inzibackend.Core.Base;

public abstract class inzibackendQueryBase<TField, TResult> : ITransientDependency
{
    ...
    protected inzibackendQueryBase(string fieldName,
