...
using inzibackend.DynamicEntityPropertyValues.Dto;

namespace inzibackend.DynamicEntityProperties;

[AbpAuthorize(AppPermissions.Pages_Administration_DynamicEntityPropertyValue)]
public class DynamicEntityPropertyValueAppService : inzibackendAppServiceBase, IDynamicEntityPropertyValueAppService
{
