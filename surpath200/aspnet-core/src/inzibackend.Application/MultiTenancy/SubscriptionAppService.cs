...
public class SubscriptionAppService : inzibackendAppServiceBase, ISubscriptionAppService
{
    ...
    {
        return upgradeAmount < inzibackendConsts.MinimumUpgradePaymentAmount;
    }
