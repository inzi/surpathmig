...
using inzibackend.MultiTenancy.Payments.Stripe;
using inzibackend.MultiTenancy.Payments.Stripe.Dto;
using Stripe.Checkout;

namespace inzibackend.MultiTenancy.Payments;

public class StripePaymentAppService : inzibackendAppServiceBase, IStripePaymentAppService
{
                ...
                .Select(p => new SessionLineItemOptions
                {
                    ...
                    PriceData = new SessionLineItemPriceDataOptions
                    {
                        ...
                        ProductData = new SessionLineItemPriceDataProductDataOptions
                        {
                            ...
                            Name = inzibackendConsts.ProductName
                        }
                    }
                }).ToList();
        }
