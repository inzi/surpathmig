...
using inzibackend.MultiTenancy.Payments.Paypal;
using inzibackend.MultiTenancy.Payments.PayPal;
using inzibackend.MultiTenancy.Payments.PayPal.Dto;

namespace inzibackend.MultiTenancy.Payments;

public class PayPalPaymentAppService : inzibackendAppServiceBase, IPayPalPaymentAppService
{
