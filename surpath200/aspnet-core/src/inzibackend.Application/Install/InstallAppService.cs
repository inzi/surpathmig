...
[AbpAllowAnonymous]
[DisableAuditing]
public class InstallAppService : inzibackendAppServiceBase, IInstallAppService
{
    private readonly AbpZeroDbMigrator<inzibackendDbContext> _migrator;
    ...
    {
        var connectionString = _appConfiguration[$"ConnectionStrings:{inzibackendConsts.ConnectionStringName}"];
    ...
    {
        EditAppSettingsjson($"ConnectionStrings:{inzibackendConsts.ConnectionStringName}", constring);
    }
