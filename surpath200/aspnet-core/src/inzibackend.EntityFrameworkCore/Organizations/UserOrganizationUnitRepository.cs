...
public class UserOrganizationUnitRepository : inzibackendRepositoryBase<UserOrganizationUnit, long>,
    IUserOrganizationUnitRepository
{
    public UserOrganizationUnitRepository(IDbContextProvider<inzibackendDbContext> dbContextProvider)
