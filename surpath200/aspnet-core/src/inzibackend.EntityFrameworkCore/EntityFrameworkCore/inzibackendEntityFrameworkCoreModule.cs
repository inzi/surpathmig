    ...
    public override void PreInitialize()
    {
        if (!SkipDbContextRegistration)
        {
            Configuration.Modules.AbpEfCore().AddDbContext<inzibackendDbContext>(options =>
            {
                ...
                {
                    inzibackendDbContextConfigurer.Configure(options.DbContextOptions,
        ...
        Configuration.EntityHistory.Selectors.Add("inzibackendEntities", EntityHistoryHelper.TrackedTypes);
