...
using inzibackend.Web.MultiTenancy;
using Abp.HtmlSanitizer;
using Microsoft.AspNetCore.Authentication.Cookies;
using inzibackend.Web.Authentication.PasswordlessLogin;
using inzibackend.Web.OpenIddict;
...
public class Startup
{
    ...
    public IServiceProvider ConfigureServices(IServiceCollection services)
    {
        ...
        return services.AddAbp<inzibackendWebHostModule>(options =>
        {
...
#pragma warning disable CS0162
        if (inzibackendConsts.PreventNotExistingTenantSubdomains)
        {
