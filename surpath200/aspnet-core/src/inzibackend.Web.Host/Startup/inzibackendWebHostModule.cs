...
using inzibackend.Web.Startup.ExternalLoginInfoProviders;
...
public class inzibackendWebHostModule : AbpModule
{
    private readonly IWebHostEnvironment _env;
    private readonly IConfigurationRoot _appConfiguration;

    public inzibackendWebHostModule(
    ...
    {
        IocManager.RegisterAssemblyByConvention(typeof(inzibackendWebHostModule).GetAssembly());
    }
