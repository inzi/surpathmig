...
public class inzibackendMailKitSmtpBuilder : DefaultMailKitSmtpBuilder
{
    private readonly ILocalizationManager _localizationManager;
    private readonly IEmailSettingsChecker _emailSettingsChecker;

    public inzibackendMailKitSmtpBuilder(
    ...
    {
        return _localizationManager.GetString(inzibackendConsts.LocalizationSourceName, name);
    }
