...
public class AppSettingProvider : SettingProvider
{
    ...
    private IEnumerable<SettingDefinition> GetDashboardSettings()
    {
        ...
        return new[]
        {
                ...
                new SettingDefinition(
                    GetSettingName(
                        inzibackendDashboardCustomizationConsts.Applications.React,
    ...
    public Dashboard GetDefaultMvcHostDashboardView()
    {
        ...
        return new Dashboard
        {
            ...
            Pages = new List<Page>
                {
                    new Page($"Page_{inzibackendDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard}_{inzibackendDashboardCustomizationConsts.DefaultPageUniqueName}_{1}")
                    {
    ...
    public Dashboard GetDefaultMvcTenantDashboardView()
    {
        ...
        return new Dashboard
        {
            ...
            Pages = new List<Page>
                {
                    new Page($"Page_{inzibackendDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard}_{inzibackendDashboardCustomizationConsts.DefaultPageUniqueName}_{1}")
                    {
                        Name = inzibackendDashboardCustomizationConsts.DefaultPageName,
                        Widgets = new List<Widget>
                        {
