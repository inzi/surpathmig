...
public class StripeGatewayManager : inzibackendServiceBase,
    ...
    ITransientDependency
{
    ...
    public async Task<StripeIdResponse> GetOrCreatePlanForPayment(long paymentId)
    {
        ...
        var product = await GetOrCreateProductAsync(inzibackendConsts.ProductName);
