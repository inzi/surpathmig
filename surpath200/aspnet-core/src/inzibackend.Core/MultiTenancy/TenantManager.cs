...
using inzibackend.MultiTenancy.Subscription;
    ...
    IEventHandler<RecurringPaymentSucceedEventData>
{
    ...
    public void HandleEvent(RecurringPaymentSucceedEventData eventData)
    {
        _unitOfWorkManager.WithUnitOfWork(() =>
        {
            ...
            if (editionItem == null || !editionItem.Product.Equals(inzibackendConsts.ProductName))
            {
                Logger.Warn(
                    $"This is not a payment for {inzibackendConsts.ProductName} for edition subscription cycle! " +
