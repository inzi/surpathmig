...
/// </summary>
public class inzibackendSimplePermissionDependency : IPermissionDependency
{
    /// <summary>
    ...
    /// </summary>
    public inzibackendSimplePermissionDependency()
    {
    ...
    public inzibackendSimplePermissionDependency(params string[] permissions)
    {
    ...
    /// </param>
    /// <param name="permissions">The permissions.</param>
    public inzibackendSimplePermissionDependency(bool requiresAll, params string[] permissions)
        : this(permissions)
    {
