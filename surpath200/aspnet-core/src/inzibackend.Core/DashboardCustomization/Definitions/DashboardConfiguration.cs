...
using inzibackend.DashboardCustomization.Definitions.Cache;
...
public class DashboardConfiguration : ITransientDependency
{
        ...
        IAbpSession abpSession)
    {
        ...
        var simplePermissionDependencyForTenantDashboard =
            new inzibackendSimplePermissionDependency(AppPermissions.Pages_Tenant_Dashboard);
        ...
        var generalStats = new WidgetDefinition(
            ...
            "WidgetGeneralStats",
            side: MultiTenancySides.Tenant,
            permissionDependency: new inzibackendSimplePermissionDependency(
                requiresAll: true,
        ...
        var simplePermissionDependencyForHostDashboard =
            new inzibackendSimplePermissionDependency(AppPermissions.Pages_Administration_Host_Dashboard);
