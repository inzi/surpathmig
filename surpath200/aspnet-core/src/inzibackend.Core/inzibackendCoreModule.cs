...
using inzibackend.Authorization.Ldap;
using inzibackend.Authorization.PasswordlessLogin;
using inzibackend.Authorization.QrLogin;
using inzibackend.Authorization.Roles;
using inzibackend.Authorization.Users;
using inzibackend.Chat;
using inzibackend.Configuration;
using inzibackend.DashboardCustomization.Definitions;
using inzibackend.Debugging;
using inzibackend.DynamicEntityProperties;
...
[DependsOn(
    typeof(inzibackendCoreSharedModule),
...
public class inzibackendCoreModule : AbpModule
{
    public override void PreInitialize()
    {
        ...
        inzibackendLocalizationConfigurer.Configure(Configuration.Localization);
        ...
        Configuration.MultiTenancy.IsEnabled = inzibackendConsts.MultiTenancyEnabled;
        ...
        Configuration.ReplaceService<IMailKitSmtpBuilder, inzibackendMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
        ...
        Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
        {
            Configuration.IocManager.IocContainer.Register(
                Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                         .ImplementedBy<inzibackendSmtpEmailSenderConfiguration>()
                         .LifestyleTransient()
            );
        });
