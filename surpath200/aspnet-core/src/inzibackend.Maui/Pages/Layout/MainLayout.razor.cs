...
using inzibackend.Maui.Core.Helpers;
...
using inzibackend.Maui.Services.Tenants;
using inzibackend.Maui.Services.UI;

#if ANDROID
using inzibackend.Maui.Core.Platforms.Android.HttpClient;
#endif
#if IOS
using inzibackend.Maui.Core.Platforms.iOS.HttpClient;
#endif
