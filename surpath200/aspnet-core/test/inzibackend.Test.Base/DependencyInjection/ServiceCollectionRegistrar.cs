...
namespace inzibackend.Test.Base.DependencyInjection;
...
public static class ServiceCollectionRegistrar
{
    public static void Register(IIocManager iocManager)
    {
        ...
        iocManager.IocContainer.Register(
            Component
                .For<DbContextOptions<inzibackendDbContext>>()
        ...
        new inzibackendDbContext(builder.Options).Database.EnsureCreated();
    }
