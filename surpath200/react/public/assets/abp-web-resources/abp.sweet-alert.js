...
(function () {
  var showMessage = function (type, message, title, options) {
    ...
    options.confirmButtonText =
      options.confirmButtonText ||
      abp.localization.localize("Ok", "inzibackend");
  ...
  abp.message.confirm = function (message, title, callback, options) {
    ...
    options.title = title
      ? title
      : abp.localization.localize("AreYouSure", "inzibackend");
    options.icon = options.icon || "warning";

    options.confirmButtonText =
      options.confirmButtonText ||
      abp.localization.localize("Yes", "inzibackend");
    options.cancelButtonText =
      options.cancelButtonText ||
      abp.localization.localize("Cancel", "inzibackend");
